...
class HomeSubCategoryItemsViewModel : ViewModel() {
    ...
    fun fetchMockItemsTestsByCategory(sub_category_id: String) {
        viewModelScope.launch {
            _isLoading.value = true
            _error.value = null
            ServiceManager.getDataManager().getMockItemsTestByCategory(object : Callback<MockListMainRes> {
